...
export const metadata: Metadata = {
  ...
  keywords: [
    "Ecommet Solutions",
    "Magento 2 certified developer in Mumbai",
    "hire Adobe certified Magento developer India",
    "custom Shopify store setup India",
    "eCommerce development for B2B startups",
    "Magento headless commerce expert",
    "Shopify Plus development services",
    "Magento 2 third-party API integration freelancer",
    "Best web development company in Mumbai",
    "Ecommerce solutions for startups",
    "Magento website development in India",
    "custom web development",
    "magento module development at affordable rates",
